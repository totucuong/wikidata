 ...
 */
public class ItemDiscussionPageGenerator {
    ...
    public ItemDiscussionPageGenerator(String items_file) {
    ...
    public static void main(String[] args) throws Exception {
        ItemDiscussionPageGenerator gen = new ItemDiscussionPageGenerator("data/items_with_discussion.csv");
        gen.run();
    }
